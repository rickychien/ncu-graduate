...
(function() {
  ...
  LightboxOptions = (function() {
    ...
    function LightboxOptions() {
      this.fileLoadingImage = './bin/lightbox/images/loading.gif';
      this.fileCloseImage = './bin/lightbox/images/close.png';
  ...
  Lightbox = (function() {
    ...
    Lightbox.prototype.enable = function() {
      var _this = this;
      return $('body').on('click', 'a[rel^=friend], area[rel^=friend]', function(e) {
